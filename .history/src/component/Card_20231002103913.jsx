...
function Card({ link, icon, title, onClick }) {
  return (
    <div
      className="max-w-sm  mx-1 my-3 cursor-pointer shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition duration-300 transform hover:scale-105  hover: bg"
      onClick={onClick}
    >
