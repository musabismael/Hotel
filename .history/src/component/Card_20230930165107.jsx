function Card({ imageUrl, title, onClick }) {
  return (
    <div
      className="max-w-sm  mx-1 my-1 cursor-pointer shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition duration-300 transform hover:scale-105"
      onClick={onClick}
    >
      <div className="bg-sky-800 rounded-lg overflow-hidden shadow-lg flex flex-col items-center justify-center">
        ...
        <div className="px-4 py-2 items-center">
          <h3 className=" text-white   flex flex-col text-ellipsis items-center font-semibold">
            {title}
          </h3>
