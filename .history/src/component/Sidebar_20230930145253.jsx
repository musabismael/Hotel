...
const Sidebar = () => {
  ...
  const cardData = [
    {
      ...
      description: "Online booking, availability calendar, and booking modification.",
    ...
    },
    {
      ...
      imageUrl: "checkin-image-url.jpg",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      description: "Housekeeping schedule, maintenance requests, and inventory management.",
      imageUrl: "housekeeping-image-url.jpg",
    },
    {
      id: 6,
      title: "Guest Services",
      description: "Concierge services, room service, wake-up calls, and laundry services.",
    ...
    },
    {
      ...
      description: "Integration with on-site restaurants, bars, and gift shops.",
  ...
  return (
    <aside  style={{ zIndex: 10 }} className="#3f7b9f  w-1/5 min-h-screen p-2 shadow-xl">
      <nav>
