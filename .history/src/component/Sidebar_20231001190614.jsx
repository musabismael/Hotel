...
const Sidebar = () => {
  ...
  return (    <aside className="bg-white-700  w-1/5 min-h-screen p-4 shadow-lg   ">

          <aside className="p-4 h-screen overflow-y-auto bg-gradient-to-b from-blue-500 via-purple-500 to-pink-500 shadow-lg">
