function Card({ imageUrl, title, onClick }) {
  return (
    ...
    >
      ...
      <img src={imageUrl} alt={title} className="w-full h-32 object-cover  items-center" />
      <div className="px-4 py-2 items-center">
        <h3 className="text-lg text-white flex flex-col items-center  font-semibold">{title}</h3>
