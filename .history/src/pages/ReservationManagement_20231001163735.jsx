...
const ReservationForm = ({ onAddReservation }) => {
  ...
  return (
    <div className="my-4 p-4 border rounded-lg">
      <h2 className="text-lg text-white font-semibold">Make a Reservation</h2>
      <form onSubmit={handleSubmit} className="mt-2">
        ...
        <div className="mb-4">
          <label htmlFor="checkInDate" className="block text-white font-semibold">
            Check-In Date
          </label>
          <input
            type="date"
        ...
        <div className="mb-4">
          <label htmlFor="checkOutDate" className="block text-white font-semibold">
            Check-Out Date
          </label>
          <input
            type="date"
    ...
    <div className="mt-4">
      ...
      <ul className="mt-2">
        {reservations.map((reservation, index) => (
          <li key={index} className="border rounded-md p-2 mb-2 text-golden">
