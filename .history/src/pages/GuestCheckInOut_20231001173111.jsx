  ...
  return (
    <div className="container mx-auto p-4">
      <div className="my-4 p-4 border rounded-lg">
        <h2 className="text-lg text-gray-800 font-semibold mb-4">Guest Check-Out</h2>
        {!isCheckedOut ? (
          <form onSubmit={handleCheckOut} className="mt-2">
            <div className="mb-4">
              <label htmlFor="reservationId" className="block text-gray-600 font-semibold mb-1">
                Reservation ID
              </label>
              <input
                type="text"
          ...
          <>
            <div className="mt-4">
              ...
              <p className="text-gray-600">Check-Out Date: {new Date().toLocaleString()}</p>
              <h3 className="text-gray-800 mt-4 font-semibold">Bill Summary:</h3>
              <p className="text-gray-600">Room Charges: ${reservationData.totalCost}</p>
              <p className="text-gray-600">Additional Charges: ${bill - reservationData.totalCost}</p>
              <p className="text-gray-600">Total Bill: ${bill}</p>
              {isFeedbackSubmitted ? (
                <p className="text-green-600 mt-4">Thank you for your feedback!</p>
              ) : (
                <>
                  <h3 className="text-gray-800 mt-4 font-semibold">Guest Feedback:</h3>
                  <textarea
                    className="w-full border rounded-md py-2 px-3"
                    rows="4"
              ...
              {!isReceiptGenerated ? (
                ...
                <p className="text-green-600 mt-4">Receipt generated and sent to guest.</p>
              )}
            </div>
            <button
              type="button"
